...
class TestDataBase extends TestDataBaseCommon
{
    ...
    public function test_connect()
    {
        ...
        $this->assertTrue(
            $db->checkOutput(
                '{"error":"Impossible to connect to \'localhost\' with MySQL SQLSTATE[28000] [1045] Access denied for user \'test\'@\'localhost\' (using password: YES)"}'));
        ...
        $this->assertTrue(
            $db->checkOutput(
                '{"error":"Impossible to connect to \'localhost\' with MySQL SQLSTATE[28000] [1045] Access denied for user \'tes\'@\'localhost\' (using password: YES)"}'));
    }
}
?>